...
/**
 * Representation of all data related to a video Item.
 *
 * @api
 */
class Video extends ItemBase {
  /**
   * The video id.
   *
   * @var string
   ...
   * this array will contain geo Items which represents
